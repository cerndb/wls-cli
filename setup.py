...
setup(name='cerndb-infra-wls_rest',
		...
		packages=['wlscli','wlscli.common','wlscli.controller', 'wlscli.controller.console', 'wlscli.model', 'wlscli.view',
			'wlscli.model.business_logic','wlscli.model.data','wlscli.service', 'wlscli.service.curl', 
                        'wlscli.service.weblogic', 'wlscli.service.security', 'wlscli.service.security.data', 
                        'wlscli.service.security.data.data_access', 'wlscli.view.console_ui'],
